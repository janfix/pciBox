...
define(['qtiCustomInteractionContext', 'IMSGlobal/jquery_2_1_1', 'boxer/runtime/js/renderer', 'OAT/util/event'], function(qtiCustomInteractionContext, $, renderer, event){
    'use strict';
    ...
    var boxer = {
        ...
        getResponse : function getResponse(){
            ...
            var Scontainer = $(this.dom),
                value = 'this is a string';// TO DO Response System
    ...
    qtiCustomInteractionContext.register(boxer);
});
